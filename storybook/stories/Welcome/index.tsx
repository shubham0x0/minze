...
export default class Welcome extends React.Component<{ showApp: any }, {}> {
  styles = {
    wrapper: {
      flex: 1,
      padding: 24,
  ...
  static defaultProps: { showApp: any };
  static propTypes: { showApp: PropTypes.Requireable<(...args: any[]) => any> };
