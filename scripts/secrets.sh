...
if [[ $MODE == "pack" ]]; then
  ...
  SECRETS_TO_PACK="app/config/keys.ts fastlane/.env fastlane/.env.secret android/app/src/main/assets/appcenter-config.json android/app/debug.keystore android/app/${GRADLE_KEYSTORE} android/app/google-services.json"
  # Create archive
