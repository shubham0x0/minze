...
import { Theme, Colors, Layout, Fonts } from '../../theme';
    ...
    return (
      <View style={localstyles.containerHeader}>
        ...
        <View style={localstyles.header}>
          <TouchableIcon
            icon={<Feather color={Theme.text} name="chevron-left" />}
            onPress={() => navigation.goBack(null)}
          />
          <Animated.View style={{ opacity: opacityShuffle }}>
            <Text style={localstyles.headerTitle}>Hello, Testing</Text>
          </Animated.View>
          <TouchableIcon icon={<Feather color={Theme.text} name="more-horizontal" />} onPress={() => null} />
        </View>
      </View>
    );
  }
